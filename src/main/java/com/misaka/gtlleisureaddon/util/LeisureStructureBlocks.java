...
public final class LeisureStructureBlocks {
    ...
    public static boolean isDecorativeSheet(BlockState state) {
        return state.getBlock() == BLACK_METAL_SHEET.getBlock() || state.getBlock() == BROWN_METAL_SHEET.getBlock() || state.getBlock() == GRAY_METAL_SHEET.getBlock() || state.getBlock() == GREEN_METAL_SHEET.getBlock() || state.getBlock() == LIGHT_GRAY_METAL_SHEET.getBlock();
    }
